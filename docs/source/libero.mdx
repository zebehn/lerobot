...
> [!NOTE]
> This fork writes per-run training logs to `train.log` and stores experiment reports under `reports/`.
> See `reports/libero_10_eval_2026-03-05.md` for the latest LIBERO-10 ACT results.
